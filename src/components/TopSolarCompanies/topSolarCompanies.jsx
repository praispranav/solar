...
import './topSolarCompanies.css';

import logo from '../../assets/logo.svg';
import footer from '../../assets/footer.svg'

export const TopSolarCompanies = () => {
    return <div className="top-solar-companies">
        ...
        <div className="top-solar-companies-content">
            ...
            <p className="small bold">Matched solar partners included but not limited to:</p>
            <ul className='small align-left'>
            <li>0Titan Solar &amp; Remodeling</li>
            <li>1 Solar Solutions</li>
            ...
            <li>310 Solar LLC</li>
            <li>31Solar LLC</li>
            <li>360 Solar Energy</li>
            <li>360 Solar Group</li>
            <li>5 Mile Media</li>
            <li>76 Solar</li>
            <li>A &amp; R Solar</li>
            ...
            <li>A1A Solar</li>
            <li>A1A Solar Contracting Inc.</li>
            ...
            <li>Acro Energy</li>
            <li>Active Energies</li>
            <li>Active Energies Inc.</li>
            <li>Active Energies Solar</li>
            <li>Active Solar</li>
            <li>Activus Corp</li>
            <li>Addin Solar</li>
            ...
            <li>Advanced Solar Electric, Inc.</li>
            <li>Advanced Solar Energy</li>
            <li>Advanced Solar Power Inc.</li>
            <li>Advanced Solar Tech</li>
            ...
            <li>Alternative Power Enterprise</li>
            <li>Alternative Power Solutions Corp.</li>
            <li>Alternative Power Systems</li>
            <li>Alternative Power Systems Inc.</li>
            <li>AM Solar</li>
            <li>Am Sun Solar</li>
            ...
            <li>American Electric (See Sunrun)</li>
            <li>American Green Energy Source, Inc.</li>
            ...
            <li>American Solar Energy (Jason Obermiller)</li>
            ...
            <li>Applied Solar Energy / Solex</li>
            <li>APS Solar</li>
            <li>Aram Solar</li>
            ...
            <li>Arizona Energy Pros Inc.</li>
            <li>Arizona Solar Concepts</li>
            ...
            <li>Automated Lead Generation LLC</li>
            ...
            <li>Benefitlogix Marketing Group, llc.</li>
            ...
            <li>Carlson Electric</li>
            <li>Carr Creek Electric Service</li>
            <li>Carr Creek Electric Service LLC</li>
            ...
            <li>CIR Electric Construction</li>
            ...
            <li>Clean Energy Collective, LLC</li>
            ...
            <li>Clear Satellite</li>
            <li>Clear Solar Company</li>
            <li>Clear Solar Energy</li>
            <li>Cleveland Solar &amp; Wind</li>
            <li>Club Solar</li>
            <li>CM Solar Electric</li>
            ...
            <li>DJ Belanger Enterprises</li>
            <li>DMI Partners</li>
            <li>DNJ Home Imporovement Consultants, Inc</li>
            ...
            <li>Ecomark Solar LLC</li>
            <li>Ecomen Solar</li>
            <li>Economic Energy Solutions</li>
            <li>Econstruction</li>
            ...
            <li>Electric Connection Solar</li>
            ...
            <li>Empower Solar Store</li>
            <li>EMS Contracting Corp</li>
            <li>Encon</li>
            ...
            <li>Engineered Solar</li>
            <li>Engineered Solar &amp; MEP Systems</li>
            <li>Enlyten Energy</li>
            <li>Envinity Inc.</li>
            ...
            <li>Ethosolar</li>
            <li>ETI Services</li>
            <li>Euclid Energy Performance Contractors</li>
            ...
            <li>FiveStrata - Data</li>
            <li>Flatiron Solar</li>
            <li>Flatiron Solar LLC</li>
            ...
            <li>Green Spring Energy (NC)</li>
            <li>Green Store</li>
            <li>Green Street Solar Power</li>
            <li>Greenbelt Solar LLC</li>
            ...
            <li>Hawaiian Island Solar Inc.</li>
            <li>Healthy Homes America</li>
            <li>Healthy Homes America Inc</li>
            <li>HelioPower</li>
            ...
            <li>I-Group Renewable Incorporated &amp; The Institute of Computer Aided Design and Drafting (ICADD International)</li>
            ...
            <li>Innovative Energy a.k.a. renewablepower.com</li>
            ...
            <li>KC Larson</li>
            <li>Kenergy Solar</li>
            <li>Keola Hunt (Sun Edison Rep)</li>
            <li>Kevin Farrell</li>
            ...
            <li>Kings Electric &amp; AC</li>
            <li>Kiss Electric LLC</li>
            <li>Kopp Electric</li>
            ...
            <li>L.I. Green Team</li>
            <li>LA Solar Energy</li>
            <li>LA Solar Group</li>
            <li>Las Vegas Solar Solutions</li>
            <li>Laser Marketing</li>
            <li>Laser Marketing</li>
            ...
            <li>Lender411.com</li>
            <li>LG TEST</li>
            <li>LHF Marketing Corp.</li>
            <li>Libertas Solar and Electric LLC</li>
            <li>Life Style Solar</li>
            <li>Lifestyle Solar</li>
            <li>Light Wave Solar</li>
            ...
            <li>Louis Paulucci</li>
            <li>LTRLED Lighting</li>
            <li>Lucerne Pacific</li>
            <li>LumiNation Home Energy</li>
            <li>Luminous Solar</li>
            <li>M. T Ruhl Electrical Contracting</li>
            <li>Mac Solar</li>
            <li>Madan Contact Centers Corporation</li>
            ...
            <li>Michele DeGeorge</li>
            <li>Michigan Solar &amp; Wind Power Solutions</li>
            <li>Microgrid Energy</li>
            <li>Microgrid Solar (Customer Service Center LLC)</li>
            ...
            <li>New Jersey Clean Energy Solutions</li>
            <li>New Market Holdings</li>
            <li>New Solar Inc.</li>
            ...
            <li>Nexus Solar</li>
            <li>Nicholas Gianatiempo (Vivint)</li>
            <li>Nippon Energy Inc.</li>
            <li>NJ Solar Now</li>
            <li>NJ Solar Power LLC</li>
            <li>NOA</li>
            <li>Noble Contractors</li>
            <li>Nor Cal Solar Power</li>
            <li>Nor Cal Solar Services</li>
            <li>North Shore Solar &amp; Wind Power</li>
            <li>Northeast Solar &amp; Wind</li>
            ...
            <li>One Roof Energy (Nahass)</li>
            <li>One Way Electric</li>
            <li>One Way Solar</li>
            <li>Oneworld Sustainable</li>
            <li>Onforce Solar</li>
            <li>Only American Solar</li>
            ...
            <li>Paradyme</li>
            <li>Paradyme Marketing LLC</li>
            <li>Paramount Equity Solar</li>
            <li>Paramount Equity Solar (PS-Partners)</li>
            ...
            <li>Positive Synergy</li>
            <li>Powell Energy &amp; Solar</li>
            <li>Power Evolution</li>
            <li>Power Factor LLC</li>
            <li>Power Home and Solar</li>
            ...
            <li>Reliable Power and Solar</li>
            <li>Reliable Power and Solar – Darren</li>
            <li>Reliant LLC</li>
            <li>Reliant USA LLC</li>
            <li>Renewable Energy Electric</li>
            ...
            <li>Renewable Resources inc</li>
            <li>Renewable Restoration &amp; Roofing</li>
            ...
            <li>Risen Solutions LLC</li>
            <li>Rising Sun Solar / DUPLICATE</li>
            <li>Rising Sun Solar Electric LLC</li>
            <li>Rite Fast Construction</li>
            <li>Riverland Solar LLC</li>
            <li>Rochester Solar Technologies a Division of O’Connell Electric</li>
            ...
            <li>ShurFire Solar</li>
            <li>ShurFire Solar - Data</li>
            ...
            <li>SKY Construction &amp; Engineering, Inc.</li>
            <li>Sky Energy</li>
            <li>Sky High Energy</li>
            <li>Skyline Solar</li>
            <li>Skytech Solar</li>
            <li>Slingshot Power</li>
            <li>Smart Energy Direct</li>
            <li>Smart Energy Hawaii</li>
            <li>Smart Energy Solar</li>
            <li>Smart Energy Solar, Inc.</li>
            <li>Smart Source Energy Lake Land</li>
            <li>SmartHome Solutions</li>
            ...
            <li>Sol Power</li>
            <li>Sol Power Construction, Inc.</li>
            <li>Sol Systems</li>
            ...
            <li>Solarix LLC</li>
            <li>SolarJoy&nbsp;<a>href="https://solarjoy.com/installers/"&gt;List of Installers</a></li>
            <li>SolarLouisiana</li>
            <li>Solarmarine LLC</li>
            <li>SolarMax</li>
            <li>Solarmax Technology Inc</li>
            <li>Solarology</li>
            ...
            <li>SolarStar Energy (Wilmington)</li>
            ...
            <li>Sun Valley Solar Solutions LLC</li>
            <li>Sun Wind Solutions</li>
            <li>Sun Wizard Solar</li>
            <li>Sun Works Solar Systems</li>
            <li>Sun X Solar Systems</li>
            <li>Sun-Tec</li>
            <li>Sun-Tec Solar</li>
            <li>Sun-Tech</li>
            <li>Sun-Wind Solutions LLC</li>
            <li>SUNation Solar Systems</li>
            <li>SUNation Solar Systems inc.</li>
            <li>Sunbank LLC</li>
            ...
            <li>Sunetric</li>
            <li>Sunetric DUPLICATE</li>
            <li>Sunetric TRIPLICATE</li>
            ...
            <li>Sunlight Solar (CO)</li>
            <li>Sunlight Solar Energy</li>
            <li>Sunlight Solar Energy Inc.</li>
            ...
            <li>Sunrise Energy Solutions</li>
            <li>Sunrock Solar</li>
            <li>Sunrun</li>
            <li>Sunrun Home</li>
            <li>Suns Up Solar</li>
            ...
            <li>Sunspot Solar Energy Systems LLC</li>
            ...
            <li>SunWorks Solar Systems</li>
            <li>Super Green Solutions</li>
            <li>Superior Energy Solutions</li>
            ...
            <li>Sustainable Energy Developments</li>
            ...
            <li>Syntrol Plumbing</li>
            <li>Syntrol Plumbing Heating and Air</li>
            ...
            <li>Yes! Solar Solutions</li>
            <li>Yingli Solar</li>
            <li>Your Home Solution</li>
            <li>Youvee Solar</li>
            <li>Yuma Solar</li>
            <li>Zach Sahker and Associates</li>
            <li>Zen Electric</li>
            <li>Zero Cost Solar</li>
