...
const CaliforniPrivacyNotice = () => {
  return (
    <div className="california-privacy-notice">
      ...
      <div className="inner-pages-text">
        ...
        <p>
          ...
          “you”). uniquote.com (“we”, “us”, “our”) adopts this notice to comply
          ...
          <tbody className="c-p-n-table">
            ...
            <tr>
              ...
              <td>
                ...
                <p>
                  <strong>Note:</strong>&nbsp;Personal information included in
                  this category (1) does not include publicly available
                  information that is lawfully made available to the general
                  public from federal, state, or local government records, and
                  (2) may overlap with other categories.
                </p>
              </td>
              <td>YES</td>
            </tr>
            ...
            <tr>
              ...
              <td>
                ...
                or in combination with each other or with other identifying
                data, to establish individual identity. Includes, but is not
                ...
                or a voiceprint, can be extracted, and keystroke patterns or
        ...
        <p>
          <strong>Personal information does not include:</strong>
        </p>
        <ul>
          <li>
            ...
            <ul>
              ...
              <li>
                does not include data used for a purpose that is not compatible
                with the purpose for which the data is maintained and made
                available in the government records or for which it is publicly
                maintained.
              </li>
              <li>
          ...
          <li>
            ...
            <ul>
              ...
              <li>
                ...
                the federal Gramm-Leach-Bliley Act (GLBA), the California
        ...
        <p>
          <strong>Your California Privacy Rights and Choices</strong>
        </p>
        <p>
        ...
        <p>
          <strong>(1) Right to Access Your Information</strong>
        </p>
        <p>
        ...
        <p>
          <strong>(2) Right to Request Deletion</strong>
        </p>
        <p>
        ...
        <p>
          <strong>(3) Right to Opt-Out</strong>
        </p>
        <p>
        ...
        <ul>
          <li>
            ...
            <ul>
              ...
              <li>Other personal information about you maintained by us.</li>
            </ul>
          </li>
          <li>
        ...
        <p>
          <strong>Use of an Authorized Agent</strong>
        </p>
        <p>
        ...
        <p>
          <strong>How we Verify your Request</strong>
        </p>
        <p>
        ...
        <p>When verifying a request, we consider the following factors:</p>
        <ul>
          <li>
        ...
        <p>
          <strong>(4) Right to Non-Discrimination</strong>
        </p>
        <p>
        ...
        <p>
          <strong>Email:</strong>&nbsp;compliance@uniquote.com
        </p>
        <p>
          <strong>Postal Address:</strong>&nbsp;Eruptic, Inc, 44 Wall Street,
          Suite 505, New York, NY 10005, USA
        </p>
      </div>
    </div>
  );
...
export default CaliforniPrivacyNotice;