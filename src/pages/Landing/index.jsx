    ...
    <div className="landing flex-center-col">
      <div className="lander flex-center-col">
        ...
        <div className="small media-font-14">
          Enter your ZIP Code to get a free report on solar savings & financing
          options.
        </div>
        <div className="space25" />
      ...
      <div className="branding">
        ...
        <div className="space25" />
        <div className="small media-font-14">
          BrightSuite is Virginia’s one-stop-shop for renewable energy. Curious
          about what a residential solar panel system actually costs and how
          much it will save on your electric bill? Speak to our experts and get
          a comprehensive solar proposal to see your return on investment
          timeline. Learn if your roof qualifies for solar, along with the best
          home solar panels, installation, financing, and maintenance for your
          home.
        </div>
      </div>
      ...
      <div className="features">
        ...
        <div>
          ...
          <div className="space20"></div>
          <div>
            Take advantage of Virginia solar incentives and earn credits on your
            electric bill. Help the environment and increase your home’s value
      ...
      <div className="details flex-center-col">
        <details>
          ...
          <p className="small media-font-14 grey">
            The federal solar investment tax credit (ITC) will have the biggest
            impact on the cost of your solar installation and is good at least
            through the end of 2022. This credit is 26% off the entire cost of
            the system including equipment, labor, and permitting. But hurry!
            The ITC credit drops to 22% in 2023, and the tax credit for
            Residential Solar drops to 0% in 2024.
          </p>
        </details>
      ...
      <div className="flex-center your-choice">
        ...
        <div className="flex-col-align-cen inside-float-left">
          ...
          <div className="space25" />
          <div className="small">
            BrightSuite is a local Virginia solar company that provides you with
            options when it comes to paying for renewable energy. From cash
            purchases to loans to tax credits, you’ll get all the information
            you need to make a smart solar decision when it comes to buying
            solar panels.
          </div>
        </div>
      </div>
      ...
      <div className="flex-center-col payment-option">
        ...
        <div className="space25" />
        <div className="small">
          Rising energy costs and falling equipment costs are making it easy for
          homeowners to justify owning their own solar power systems.
      ...
      <div className="flex-center-col home-solution">
        ...
        <div className="small align-left">
          ...
          staffed right here in Richmond, Virginia. Our local team of installers
          serves the entire state including Northern Virginia, Hampton Roads,
      ...
      <div className="small media-font-14 grey padding-w12 margin-bot-70">
        ...
        the same company. BrightSuite’s services are not regulated by a state’s
        Public Service Commission. Your choice of whether to participate in any
        BrightSuite offerings will not affect the price, availability, or terms
        of service from a Dominion Energy regulated utility and shall receive no
        preference or special treatment. A customer does not have to select
        BrightSuite services to continue to receive the same safe and reliable
        electric service or natural gas service from Dominion Energy.
      </div>
    </div>
  );
};
